                ...
                <ul className='list-none '>
                            ...
                            <li className='text-[1.2rem] font-normal font-serif text-slate-950' >
                                <div className='flex items-center'>
                                    <input type="checkbox"  className='h-5 w-[18px] me-3 cursor-pointer accent-blue-500 '  /><label htmlFor="">Full Time</label>
                                </div>
                            </li>
                   
                            <li className='text-[1.2rem] font-normal font-serif text-slate-950'>
                                <div className='flex items-center'>
                                    <input type="checkbox"  className='h-5 w-[18px] me-3 cursor-pointer accent-blue-500 '  /><label htmlFor="">Part Time</label>
                                </div>
                            </li>
                            ...
                            <li className='text-[1.2rem] font-normal font-serif text-slate-950'>
                                <div className='flex items-center'>
                                    <input type="checkbox"  className='h-5 w-[18px] me-3 cursor-pointer accent-blue-500 '  /><label htmlFor=""> Temporary</label>
                                </div>
                            </li>
