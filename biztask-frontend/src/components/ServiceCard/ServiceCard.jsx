...
const ServiceCard = ({business,provider}) => {
  return (
   <>
...
<span className="text-xl font-serif font-semibold  text-[#323d80]">{business?.serviceType}</span>
<span className="text-md font-serif font-normal  text-[#3b3f55]">{provider}</span>
</div>

<div className=' flex justify-between items-center px-4 pb-4'>
    
    <Link to={`/service-detail/${business?._id}`}>
