  ...
  return (
    <>
      <div id={index} className="relative w-full max-w-sm mx-auto group transition-all duration-300">
        ...
        <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-emerald-700 rounded-3xl opacity-20 blur-sm transition-all duration-300 group-hover:opacity-40"></div>
        ...
        <div className="relative bg-white/90 backdrop-blur-lg rounded-3xl overflow-hidden shadow-lg border border-blue-100 
          ...
          {/* Header  */}
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 p-6 rounded-t-3xl relative">
            <div className="flex items-center gap-6">
              
              {/* Company Logo */}
              <div className="w-24 h-24 rounded-xl overflow-hidden shadow-md border-2 border-slate-600 flex-shrink-0 "
                style={{
          ...
          <div className="px-4 py-3 bg-gray-50 text-gray-600 text-sm border-b border-gray-200">
            <div className="flex justify-between">
              <span className='font-serif font-semibold'>ID: {businessDetails?._id}</span>
          ...
          <div className="p-4 bg-white flex justify-around">
            ...
            <Link to={`/bussiness-update/${businessDetails?._id}`}>
              <button className="p-3 rounded-full bg-gradient-to-r from-slate-500 to-slate-700 text-white shadow-md 
                hover:shadow-lg hover:scale-110 transition-all duration-200">
