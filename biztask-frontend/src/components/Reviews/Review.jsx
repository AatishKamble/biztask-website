      ...
      <div className="p-6">
        <div className="flex items-start">
          ...
          <div className="mr-5 flex flex-col items-center">
            <motion.div 
              className={`w-14 h-14 rounded-full overflow-hidden border-2 ${isOwnReview ? 'border-blue-500' : 'border-gray-300'} shadow-md`}
          ...
          <div className="flex-1">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              ...
              <motion.span 
                className="bg-green-50 flex items-center text-green-700 text-xs px-4 py-1.5 rounded-full font-medium border border-green-100"
