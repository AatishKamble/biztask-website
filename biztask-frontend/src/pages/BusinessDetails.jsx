...
<div className='bg-white flex relative flex-col items-center w-full h-auto px-6 sm:px-10 lg:px-16'>
      ...
      {/* Profile Section */}
      <div className='w-full bg-gradient-to-r from-blue-200 to-blue-300 drop-shadow-lg mt-10 mb-6 flex flex-col justify-center items-center p-10 rounded-2xl shadow-md'>
